...
func (tm *ThemeManager) FetchMarketThemes() ([]KomariThemeItem, error) {
	...
	if !hasBtop {
		...
		btopTheme := KomariThemeItem{
			...
			DownloadURL: "https://github.com/wildalley/komari-theme-btop/releases/download/v1.0.2/btop-terminal.zip",
			SHA256:      "400e73163162aabbaf8928d947f0e4760b5e5db973d69ad9e22ed589057a1e66",
			IsInstalled: isInstalled,
